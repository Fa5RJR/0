...
class MyArm extends StatelessWidget {
   MyArm({super.key});
  ...
  Widget build(BuildContext context) {
    return  MaterialApp(
      ...
      home: ArmPage(categoryTitle: 'Arm'),
    );
  }
}
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  ...
                  child: const Text("Sort by Name", style: TextStyle(color: Colors.white)),
                ),
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF1CB5A3),
                  ...
                  child: const Text("Sort by Price", style: TextStyle(color: Colors.white)),
                ),
              ],
            ),
